...
int main(){
	...
	cin>>Ua >> Ub;
	cout<<"Enter Thermal conductivity, Area, Length of rod & No. of nodal points:\n";
	cin>>k>>A>>L>>n;
...
*********************************************OUTPUT********************************************
// Enter the temperature at ends:
// 100
// 500
// Enter Thermal conductivity, Area, Length of rod & No. of nodal points:
// 1000
// 0.01
// 0.5
// 5
